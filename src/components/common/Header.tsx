...
import { Shield, LogOut, User, Hospital } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({ title }) => {
  const { user, hospital, userType, logout } = useAuth();
        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Secure Health Records</p>
            </div>
          </div>
